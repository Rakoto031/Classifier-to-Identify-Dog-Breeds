...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['pct_correct_dogs']))
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['pct_correct_breed']))
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['pct_correct_notdogs']))
    print("{:20}: {:3d}".format('N Not-Dog Images', results_stats_dic['pct_match']))
    """
